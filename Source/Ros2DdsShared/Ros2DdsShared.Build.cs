...
public class Ros2DdsShared : ModuleRules
{
	public Ros2DdsShared(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Directory.Exists(Path.Combine(CycloneRoot, "include", "dds")))
		{
			...
			PublicDefinitions.Add("WITH_ROS2_DDS=1");
			PublicDefinitions.Add("WITH_LIDAR360_DDS=1");
		}
		else
		{
			PublicDefinitions.Add("WITH_ROS2_DDS=0");
			PublicDefinitions.Add("WITH_LIDAR360_DDS=0");
		}
